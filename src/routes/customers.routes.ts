...
router.post(
  ...
  validate([
    ...
    body("name2").optional().isString(),
    body("legacyCustomerId").optional().isInt(),
    body("organizationName").optional().isString(),
    body("organizationType").optional().isString(),
    body("contactPersonName").optional().isString(),
    body("registrationNumber").optional().isString(),
    body("ebarimtConsumerNo").optional().isString().isLength({ max: 20 }),
    body("address").optional().isString(),
    body("district").optional().isString(),
    body("detailedAddress").optional().isString(),
    body("phoneNumber").optional().isString(),
    body("isVatPayer").optional().isBoolean(),
